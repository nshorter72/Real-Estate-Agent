...
__export(src_exports, {
  RealEstateAgent: () => RealEstateAgent_default
});
...
var RealEstateAgent = ({
  ...
  const [uploadedOffer, setUploadedOffer] = (0, import_react.useState)(null);
  const [offerDetails, setOfferDetails] = (0, import_react.useState)({
  ...
  const [generatedTimeline, setGeneratedTimeline] = (0, import_react.useState)([]);
  const [emailTemplates, setEmailTemplates] = (0, import_react.useState)([]);
...
\u25A1 Keys/garage remotes ready for transfer`
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: `max-w-6xl mx-auto p-6 bg-gray-50 min-h-screen ${className}`, children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "bg-white rounded-lg shadow-lg", children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "border-b border-gray-200", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "p-6", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex items-center space-x-3", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_lucide_react.Home, { className: "w-8 h-8 text-blue-600" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", { className: "text-2xl font-bold text-gray-900", children: "Real Estate AI Agent" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "text-gray-600", children: "Post-Offer Management & Timeline Generator" })
        ] })
      ] }) }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("nav", { className: "flex space-x-8 px-6", children: ["upload", "details", "timeline", "emails"].map((tab) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
        "button",
        {
          ...
          children: [
            tab === "upload" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_lucide_react.Upload, { className: "w-4 h-4 inline mr-1" }),
            tab === "details" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_lucide_react.FileText, { className: "w-4 h-4 inline mr-1" }),
            tab === "timeline" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_lucide_react.Calendar, { className: "w-4 h-4 inline mr-1" }),
            tab === "emails" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_lucide_react.Mail, { className: "w-4 h-4 inline mr-1" }),
            tab
          ]
        },
        tab
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "p-6", children: [
      activeTab === "upload" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "text-center py-12", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_lucide_react.Upload, { className: "mx-auto h-12 w-12 text-gray-400" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { className: "mt-2 text-sm font-medium text-gray-900", children: "Upload Accepted Offer" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "mt-1 text-sm text-gray-500", children: "Upload the signed purchase agreement or accepted offer document" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "mt-6", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
            "label",
            {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_lucide_react.Upload, { className: "w-4 h-4 mr-2" }),
                "Choose File"
              ]
            }
          )
      ...
      activeTab === "details" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "space-y-6", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { className: "text-lg font-medium text-gray-900", children: "Enter Offer Details" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { className: "block text-sm font-medium text-gray-700", children: "Property Address" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              "input",
              {
                type: "text",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { className: "block text-sm font-medium text-gray-700", children: "Sale Price" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              "input",
              {
                type: "text",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { className: "block text-sm font-medium text-gray-700", children: "Buyer Name" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              "input",
              {
                type: "text",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { className: "block text-sm font-medium text-gray-700", children: "Seller Name" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              "input",
              {
                type: "text",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { className: "block text-sm font-medium text-gray-700", children: "Acceptance Date" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              "input",
              {
                type: "date",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { className: "block text-sm font-medium text-gray-700", children: "Closing Date" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              "input",
              {
                type: "date",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { className: "block text-sm font-medium text-gray-700", children: "Inspection Period (days)" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              "input",
              {
                type: "number",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { className: "block text-sm font-medium text-gray-700", children: "Appraisal Period (days)" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              "input",
              {
                type: "number",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "md:col-span-2", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { className: "block text-sm font-medium text-gray-700", children: "Financing Deadline (days)" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              "input",
              {
                type: "number",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "pt-4", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
          "button",
          {
            onClick: calculateDeadlines,
            className: "inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700",
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_lucide_react.Calendar, { className: "w-5 h-5 mr-2" }),
              "Generate Timeline & Emails"
            ]
          }
        ) })
      ] }),
      activeTab === "timeline" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "space-y-6", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex justify-between items-center", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { className: "text-lg font-medium text-gray-900", children: "Transaction Timeline" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "button",
            {
        ...
        generatedTimeline.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "text-gray-500", children: "Please fill out offer details and generate timeline first." }) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "space-y-4", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "bg-yellow-50 border border-yellow-200 rounded-md p-4", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", { className: "font-medium text-yellow-800", children: "HUD-Approved Housing Counseling Agencies" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "text-sm text-yellow-700 mt-1", children: "Provide these resources to buyers who need financial guidance:" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "mt-2 grid grid-cols-1 md:grid-cols-2 gap-2 text-sm text-yellow-800", children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { children: "\u2022 ACTS Housing - (414) 937-9295" }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { children: "\u2022 UCC - (414) 384-3100" }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { children: "\u2022 HIR - (414) 264-2622" }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { children: "\u2022 Green Path Financial - (877) 337-3399" })
            ] })
          ] }),
          generatedTimeline.map((item, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: `flex items-start space-x-4 p-4 rounded-lg ${item.agentAction ? "bg-blue-50 border-l-4 border-blue-400" : "bg-gray-50"}`, children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_lucide_react.Clock, { className: "w-5 h-5 text-gray-400 mt-1" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex-1", children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex items-center justify-between", children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h4", { className: "font-medium text-gray-900", children: [
                  item.task,
                  item.agentAction && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "ml-2 text-xs bg-blue-100 text-blue-800 px-2 py-1 rounded", children: "Agent Action" })
                ] }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: `px-2 py-1 text-xs font-medium rounded border ${getPriorityColor(item.priority)}`, children: item.priority })
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { className: "text-sm text-gray-600 mt-1", children: [
                "Due: ",
      ...
      activeTab === "emails" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "space-y-6", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { className: "text-lg font-medium text-gray-900", children: "Email Templates" }),
        emailTemplates.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "text-gray-500", children: "Please generate timeline first to create email templates." }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "space-y-6", children: emailTemplates.map((template, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "border border-gray-200 rounded-lg p-6", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex items-center justify-between mb-4", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", { className: "text-lg font-medium text-gray-900", children: template.title }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              "button",
              {
                onClick: () => {
...
${template.body}`);
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "space-y-3", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { className: "block text-sm font-medium text-gray-700", children: "Subject:" }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "text-sm bg-gray-50 p-2 rounded", children: template.subject })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { className: "block text-sm font-medium text-gray-700", children: "Body:" }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("pre", { className: "text-sm bg-gray-50 p-4 rounded whitespace-pre-wrap font-sans", children: template.body })
            ] })
          ] })
        ] }, index)) })
      ] })
